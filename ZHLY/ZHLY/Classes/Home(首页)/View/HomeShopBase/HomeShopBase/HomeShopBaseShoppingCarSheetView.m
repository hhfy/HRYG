...
//
//  HomeMuseumShoppingCarSheetVIew.m
//  ZHLY
//
...
@interface HomeShopBaseShoppingCarSheetView ()
...
@end
@implementation HomeShopBaseShoppingCarSheetView
...
- (IBAction)addShoppingCarBtnTap:(UIButton *)button {
    [self dismiss];
    if (self.dismissCallBack) self.dismissCallBack(self.count);
}
