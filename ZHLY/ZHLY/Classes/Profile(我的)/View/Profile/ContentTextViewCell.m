...
- (void)setupUI {
    self.questionTextView.placeholder = @"请填写退款理由......";
 ...
 replacementText:(NSString *)text
{
    ...
    else
    {
        ...
        [SVProgressHUD showError:@"内容不超过100个字"];
        return NO;
    }
