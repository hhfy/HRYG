...
/// 传递textFiled里面的内容
typedef void(^PersonalTextFiledTextDidChangeBlock)(NSString *text);
/// 监听textFiled开始编辑点击事件
typedef void(^PersonalTextFiledTextBeginEditBlock)(void);

@interface HomePersonalCell : UITableViewCell
...
@property (nonatomic, copy) PersonalTextFiledTextDidChangeBlock textDidChange;
@property (nonatomic, copy) PersonalTextFiledTextBeginEditBlock textBeginEidt;
@end
