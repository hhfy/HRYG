...
// WaveMaxHeight
static CGFloat const JElasticPullToRefreshWaveMaxHeight = 70.0;
// MinOffsetToPull
static CGFloat const JElasticPullToRefreshMinOffsetToPull = 95.0;
// LoadingContentInset
static CGFloat const JElasticPullToRefreshLoadingContentInset = 95.0;
// LoadingViewSize
static CGFloat const JElasticPullToRefreshLoadingViewSize = 20.0;
