...
-(NSString*)createMd5Sign:(NSMutableDictionary*)dict
{
    ...
    for (NSString *categoryId in sortedArray) {
        ...
        {
            [contentString appendFormat:@"%@=%@&", [categoryId lowercaseString], [dict objectForKey:categoryId]];
        }
        
    }
    //添加key字段
//    [contentString appendFormat:@"key=%@", spkey];
//    [contentString appendFormat:WXPaySecret];
    
    //[contentString appendFormat:@"key=lmr0IgnQ3ZaoRnDNHwbecWAb2aWlI4vC"];
