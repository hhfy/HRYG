...
@implementation LaiCAAnimatonLibTool

+ (void)gradientAnimatonWithLoaddingView:(UIView *)loaddingView {
    // 创建渐变效果的layer
    CAGradientLayer *graLayer = [CAGradientLayer layer];
    graLayer.frame = loaddingView.bounds;
    graLayer.colors = @[(__bridge id)[[UIColor greenColor] colorWithAlphaComponent:0.5].CGColor,
                        (__bridge id)[UIColor yellowColor].CGColor,
                        (__bridge id)[[UIColor yellowColor] colorWithAlphaComponent:0.5].CGColor];
    ...
    [graLayer addAnimation:animation forKey:nil];
    
    // 将graLayer设置成textLabel的遮罩
    loaddingView.layer.mask = graLayer;
}
...
+ (CALayer*)generateActivityIndicatorLayerWithAnimationType:(LAIActivityIndicatorAnimationType)animationType size:(CGSize)size tintColor:(UIColor *)tintColor superView:(UIView *)superView {
    ...
    CGFloat viewW = superView.width;
    CGFloat viewH = superView.height;
    
    CALayer* layer = [CALayer new];
    layer.position = CGPointMake(viewW * 0.5, viewH * 0.4);
    
    switch (animationType) {
        case LAIActivityIndicatorAnimationTypeNineDots:{
        ...
        case LAIActivityIndicatorAnimationTypeTriplePulse:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case LAIActivityIndicatorAnimationTypeFiveDots:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case LAIActivityIndicatorAnimationTypeRotatingSquares:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case LAIActivityIndicatorAnimationTypeDoubleBounce:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case LAIActivityIndicatorAnimationTypeTwoDots:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case LAIActivityIndicatorAnimationTypeThreeDots:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case LAIActivityIndicatorAnimationTypeBallPulse:{
        ...
        case LAIActivityIndicatorAnimationTypeBallClipRotate:{
            CGFloat duration = 0.75f;
        ...
        case LAIActivityIndicatorAnimationTypeBallClipRotatePulse:{
        ...
        case LAIActivityIndicatorAnimationTypeBallClipRotateMultiple:{
        ...
        case LAIActivityIndicatorAnimationTypeBallRotate:{
            CGFloat duration = 1.0f;
        ...
        case LAIActivityIndicatorAnimationTypeBallZigZag:{
        ...
        case LAIActivityIndicatorAnimationTypeBallZigZagDeflect:{
            CGFloat duration = 0.75f;
            CGFloat circleSize = size.width / 5;
            CGFloat deltaX = size.width / 2 - circleSize / 2;
            CGFloat deltaY = size.height / 2 - circleSize / 2;
        ...
        case LAIActivityIndicatorAnimationTypeBallTrianglePath:{
        ...
        case LAIActivityIndicatorAnimationTypeBallScale:{
            CGFloat duration = 1.0f;
        ...
        case LAIActivityIndicatorAnimationTypeLineScale:{
            CGFloat duration = 1.0f;
        ...
        case LAIActivityIndicatorAnimationTypeLineScaleParty:{
        ...
        case LAIActivityIndicatorAnimationTypeBallScaleMultiple:{
            CGFloat duration = 1.0f;
        ...
        case LAIActivityIndicatorAnimationTypeBallPulseSync:{
        ...
        case LAIActivityIndicatorAnimationTypeBallBeat:{
            CGFloat duration = 0.7f;
        ...
        case LAIActivityIndicatorAnimationTypeLineScalePulseOut:{
            CGFloat duration = 1.0f;
        ...
        case LAIActivityIndicatorAnimationTypeLineScalePulseOutRapid:{
        ...
        case LAIActivityIndicatorAnimationTypeBallScaleRipple:{
            CGFloat duration = 1.0f;
        ...
        case LAIActivityIndicatorAnimationTypeBallScaleRippleMultiple:{
        ...
        case LAIActivityIndicatorAnimationTypeTriangleSkewSpin:{
        ...
        case LAIActivityIndicatorAnimationTypeBallGridBeat:{
        ...
        case LAIActivityIndicatorAnimationTypeBallGridPulse:{
        ...
        case LAIActivityIndicatorAnimationTypeRotatingSandglass:{
        ...
        case LAIActivityIndicatorAnimationTypeRotatingTrigons:{
        ...
        case LAIActivityIndicatorAnimationTypeTripleRings:{
            NSTimeInterval beginTime = CACurrentMediaTime();
        ...
        case LAIActivityIndicatorAnimationTypeCookieTerminator:{
            NSTimeInterval beginTime = CACurrentMediaTime();
