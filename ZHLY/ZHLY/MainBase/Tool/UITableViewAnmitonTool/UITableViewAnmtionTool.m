...
@implementation UITableViewAnmtionTool
...
+ (void)alphaAnimationWithTableView:(UITableView *)tableView {
    ...
    for (int i = 0; i < indexPaths.count; i++) {
        ...
        UITableViewHeaderFooterView *footer = [tableView footerViewForSection:i];
        header.alpha = footer.alpha = 0.0;
        [UIView animateWithDuration:0.3 delay:i*0.08 options:0 animations:^{
            header.alpha = footer.alpha = 1.0;
        } completion:nil];
    }
    
    tableView.tableHeaderView.alpha = 0.0;
    tableView.tableFooterView.alpha = 0.0;
    ...
    for (int i = 0; i < cells.count; i++) {
        ...
        [UIView animateWithDuration:0.3 delay:i*0.08 options:0 animations:^{
            ...
            tableView.tableFooterView.alpha = 1.0f;
            tableView.mj_footer.alpha = 1.0f;
        }];
    }
}
