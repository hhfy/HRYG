...
static CGFloat kJPEGCompression = 0.35;
...
- (void)showInsertLinkDialogWithLink:(NSString *)url title:(NSString *)title {
    ...
    // Insert Button Title
    NSString *insertButtonTitle = !self.selectedLinkURL ? NSLocalizedString(@"插入", nil) : NSLocalizedString(@"更新", nil);
    ...
    if ([NSProcessInfo instancesRespondToSelector:@selector(isOperatingSystemAtLeastVersion:)]) {
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"插入链接", nil) message:nil preferredStyle:UIAlertControllerStyleAlert];
        ...
        [alertController addTextFieldWithConfigurationHandler:^(UITextField *textField) {
            textField.placeholder = NSLocalizedString(@"文字内容", nil);
            textField.clearButtonMode = UITextFieldViewModeAlways;
        ...
        self.alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"插入链接", nil) message:nil delegate:self cancelButtonTitle:NSLocalizedString(@"取消", nil) otherButtonTitles:insertButtonTitle, nil];
        ...
        alt.placeholder = NSLocalizedString(@"文字内容", nil);
        if (title) {
            alt.text = title;
        }
...
- (void)showInsertImageDialogWithLink:(NSString *)url alt:(NSString *)alt {
    ...
    // Insert Button Title
    NSString *insertButtonTitle = !self.selectedImageURL ? NSLocalizedString(@"插入", nil) : NSLocalizedString(@"更新", nil);
    ...
    if ([NSProcessInfo instancesRespondToSelector:@selector(isOperatingSystemAtLeastVersion:)]) {
        ...
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"选择网络图片", nil) message:nil preferredStyle:UIAlertControllerStyleAlert];
        [alertController addTextFieldWithConfigurationHandler:^(UITextField *textField) {
            textField.placeholder = NSLocalizedString(@"插入图片地址", nil);
            if (url) {
                textField.text = url;
            }
            textField.rightView = am;
        ...
        [alertController addTextFieldWithConfigurationHandler:^(UITextField *textField) {
            textField.placeholder = NSLocalizedString(@"Alt标签内容", nil);
            textField.clearButtonMode = UITextFieldViewModeAlways;
            textField.secureTextEntry = NO;
            if (alt) {
                textField.text = alt;
        ...
        self.alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"选择网络图片", nil) message:nil delegate:self cancelButtonTitle:NSLocalizedString(@"取消", nil) otherButtonTitles:insertButtonTitle, nil];
        self.alertView.alertViewStyle = UIAlertViewStyleLoginAndPasswordInput;
        self.alertView.tag = 1;
        UITextField *imageURL = [self.alertView textFieldAtIndex:0];
        imageURL.placeholder = NSLocalizedString(@"插入图片地址", nil);
        if (url) {
            imageURL.text = url;
        }
        ...
        alt1.placeholder = NSLocalizedString(@"Alt标签内容", nil);
...
- (void)showInsertImageDialogFromDeviceWithScale:(CGFloat)scale alt:(NSString *)alt {
    ...
    // Insert button title
    NSString *insertButtonTitle = !self.selectedImageURL ? NSLocalizedString(@"选择图片", nil) : NSLocalizedString(@"选择图片", nil);
    
    //If the OS version supports the new UIAlertController go for it. Otherwise use the old UIAlertView
    if ([NSProcessInfo instancesRespondToSelector:@selector(isOperatingSystemAtLeastVersion:)]) {
        
        UIAlertController *alertController = [UIAlertController alertControllerWithTitle:NSLocalizedString(@"从相册选择图片", nil) message:nil preferredStyle:UIAlertControllerStyleAlert];
        ...
        [alertController addTextFieldWithConfigurationHandler:^(UITextField *textField) {
            textField.clearButtonMode = UITextFieldViewModeAlways;
            textField.secureTextEntry = NO;
            textField.placeholder = NSLocalizedString(@"图片比例，默认0.5", nil);
        ...
        self.alertView = [[UIAlertView alloc] initWithTitle:NSLocalizedString(@"插入图片", nil) message:nil delegate:self cancelButtonTitle:NSLocalizedString(@"取消", nil) otherButtonTitles:insertButtonTitle, nil];
        self.alertView.alertViewStyle = UIAlertViewStyleLoginAndPasswordInput;
        self.alertView.tag = 3;
        
        UITextField *textFieldAlt = [self.alertView textFieldAtIndex:0];
        textFieldAlt.secureTextEntry = NO;
        textFieldAlt.placeholder = NSLocalizedString(@"Alt标签内容", nil);
        ...
        textFieldScale.placeholder = NSLocalizedString(@"图片比例，默认0.5", nil);
